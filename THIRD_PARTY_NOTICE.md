# Third-party and license notice

This repository is a sanitized installation mirror assembled from skills with different origins. Existing license, notice, and provenance files are preserved inside their respective skill folders. There is no single root license that replaces those terms.

## Important conditions

- Review the license inside each skill before reuse, modification, commercial use, or redistribution.
- Skills with no explicit license remain subject to their authors' default rights; public visibility does not grant additional permission.
...
The repository contains no credentials or authentication state. Each user must configure their own services and accept the applicable service terms.
