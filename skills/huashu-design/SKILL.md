---
name: huashu-design
description: 花叔Design（Huashu-Design）使用 HTML 制作高保真原型、交互 Demo、幻灯片、动画、设计变体、设计方向建议与专家评审。用于 UI mockup、prototype、App 或 iOS 原型、HTML 演示、可视化、MP4 或 GIF 动画、配音解说视频、视觉风格探索、配色方案、设计评审，以及将模糊需求发展成多个可比较设计方向。包含 Junior Designer 工作流、反 AI slop 检查、React 与 Babel 实践、Tweaks 变体、Speaker Notes、Playwright 验证、动画导出和长篇解说动画流程。
---
