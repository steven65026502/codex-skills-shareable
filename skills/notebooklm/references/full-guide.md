...
> Preserved upstream detail. Resolve all paths from the installed skill directory; Claude-specific examples are not current-host prerequisites. The root `SKILL.md` is authoritative for routing, safety, and completion.
